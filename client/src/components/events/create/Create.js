...
const Create = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log({ name, description, location, date, imageURL, club } )
        eventServices.create({ name, description, location, date, imageURL, club })
            .then(() => history.push('/'))
            .catch(err => {
                console.log(err);
            })
        ...
        <div>
            {
                user.isAdmin == true ? (
                    <form className="Create" onSubmit={handleSubmit}>
                        ...
                        <div className="input">
                            <select onChange={onChangeClub} value={club} >
                ...
                ) : <div className="illegal">You are not authorized to create an Event</div>
            }
        </div>
    )
}
