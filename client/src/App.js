...
import RegisterEvent from "./components/events/register/RegisterEvent";
        ...
        return (
            <div className="App">
                ...
                <Switch>
                    ...
                    {true && <Route path="/details/:id" component={renderCmp(Details)}/>}
                    {isLoggedIn && <Route path="/edit/:id" component={renderCmp(Edit)}/> }
                    {isLoggedIn && <Route path="/profile" component={renderCmp(Profile)}/>}
                    {isLoggedIn && <Route path="/registerEvent/:id" component={renderCmp(RegisterEvent)}/>} 
